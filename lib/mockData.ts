...
const ATTENTION: PaperArtifact = {
  ...
  game: {
    ...
    content: {
      sentences: [
        { tokens: ["The", "model", "computed", "attention", "over", "all", "positions", "and", "it", "converged", "faster"], answer: 1, explanation: "'it' refers to 'the model' which computed attention." },
        { tokens: ["Self-attention", "lets", "each", "token", "see", "every", "other", "so", "it", "captures", "long-range", "dependencies"], answer: 0, explanation: "'it' refers to 'Self-attention', the mechanism enabling long-range connections." },
        { tokens: ["The", "encoder", "processes", "input", "while", "the", "decoder", "generates", "output", "because", "it", "is", "autoregressive"], answer: 6, explanation: "'it' refers to 'the decoder' which generates output autoregressively." },
      ],
    },
  },
...
const FINE_TUNING_ALIGNMENT: PaperArtifact = {
  ...
  game: {
    ...
    content: {
      contextDescription: "The slider controls how far the fine-tuned policy can drift from the base model's distribution. DPO optimizes preferences directly without a separate reward model.",
      outputExamples: {
...
export function mockReasoning(id: string, title?: string): PaperArtifact {
  return {
    ...
    game: {
      ...
      content: {
        theme: "AI Summit Conference",
        sessionNames: ["Keynote", "RAG Workshop", "Agents Workshop", "Robotics Lab", "Safety Workshop", "Multimodal Models"],
        roomNames: ["Room A (Auditorium)", "Room B (GPU Lab)", "Room C (Classroom)"],
        slotLabels: ["10 AM", "11 AM", "1 PM", "2 PM"],
      },
    },

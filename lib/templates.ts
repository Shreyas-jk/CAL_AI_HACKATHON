...
export const TEMPLATES: TemplateMeta[] = [
  { id: "pathfinding", title: "Maze Runner (A* vs naive search)",
    categories: ["pathfinding", "planning", "search", "graph", "evaluation", "benchmark", "embedding", "similarity"],
  ...
  { id: "fine-tuning-alignment", title: "The Leash (policy drift vs reward hacking)",
    categories: ["fine-tuning", "alignment", "rlhf", "dpo", "preference", "reward model", "policy optimization", "reinforcement learning from human feedback", "pretraining", "learning rate", "loss landscape", "training stability"],
  ...
  { id: "attention", title: "Spotlight (uniform vs learned attention)",
    categories: ["attention", "transformer", "nlp", "sequence", "prompt engineering", "in-context learning", "few-shot"],
  ...
  { id: "reasoning", title: "AI Conference Scheduler (test-time compute)",
    categories: ["reasoning", "chain-of-thought", "chain of thought", "cot", "test-time", "planning", "constraint", "agentic", "tool-use", "agent", "task decomposition"],
  ...
  { id: "vision-detective", title: "Vision Detective (grounded VLM lab)",
    categories: ["multimodal", "vision-language", "vision language", "vlm", "vqa", "clip", "ocr", "document understanding", "grounding", "visual hallucination", "safety", "interpretability", "red-teaming", "adversarial"],
